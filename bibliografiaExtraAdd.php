...
<?php
	if($_POST['light'] == "green") {
		...
		$sql="INSERT INTO bibliografias_2 (autor,libro,descripcion,idtipoPaso,idUsuario) VALUES ('".$pautor."','".$plibro."','".$pdescripcion."','".$idtipopaso."','".$idusuario."')";
		...
		."<p style='text-align:center;'><a href='reporteContestar.php?id=$idtipopaso&t=$Pt&idReporte=$Pidreporte&idPasoSem=$Pidpasosem'>Regresar</a>";
...
<body>
<form method="post" onsubmit="return validar()" name="form">
...
<tr>
	...
	<td>
     <input type="text" name="libro" id="libro" style="width:90%" />
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>
     <input type="text" name="autor" id="autor" style="width:90%"/>
	</td>
	</tr>
	<tr>
	<td>
