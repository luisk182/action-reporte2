...
$sql="select * from bibliografias_2 where id=".$_GET['idb'];
...
if($_POST['light'] == "green")
{
	...
	$idbiblio=$_GET['idb'];
	$sql="update bibliografias_2 set libro='".$plibro."',autor='".$pautor."',descripcion='".$pdescripcion."' where id='".$idbiblio."'";
	$query=mysql_query($sql) or die(mysql_error());
	...
	."<p style='text-align:center;'><a href='reporteContestar.php?id=$Pid&t=$Pt&idReporte=$Pidreporte&idPasoSem=$Pidpasosem'>Regresar</a>";
