...
?> 
    <table border="0" cellpadding="0" cellspacing="0" class="tableizer-table" width="1623px">
        ...
        <tr>
            <td style="width:30px; font-size:12px;"><b>Sem</b></td>
		...
		<tr valign="top">
        	<td style="width:53px;"></td>
            <td colspan="10" style="width:390; background-color:#99CCFF; border:solid 1px #000000;"><h3>1. Primero hay que tener un <b>DOMINIO</b> del negocio</h3></td>
            <td colspan="10" style="width:390; background-color:#1FB714; background-color:#1FB714; border-top:solid 1px #000000; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>2. Después vamos a crecer en un <b>NICHO</b> de mercado</h3></td>
            <td colspan="10" style="width:430; background-color:#CC99FF;  border-top:solid 1px #000000; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>3. En seguida aseguraremos el correcto <b>APALANCAMIENTO</b> del negocio</h3></td>
            ...
            <td colspan="12" style="width:366px; background-color:#FF9900; border-top:solid 1px #000000; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>5.  Y por último lograremos tener una <b>SINERGIA</b> en todo tu negocio y con ello lograr los <b>RESULTADOS MASIVOS</b> (paso 6)</h3></td>
        </tr>
	    <tr height="5px">
        	<td></td>
            <td colspan="10" style="width:390; background-color:#99CCFF; border-left:solid 1px #000000;border-right:solid 1px #000000;"><h3>Duración: 3 meses - del mes 1 al 3</h3></td>
    		<td colspan="10" style="width:390; background-color:#1FB714; border-right:solid 1px #000000;"><h3>Duración: 4 meses - del mes 2 al 5</h3></td>
            <td colspan="10" style="width:390; background-color:#CC99FF;  border-right:solid 1px #000000;"><h3>Duración: 6 meses - del mes 3 al 8</h3></td>
            <td colspan="10" style="width:390; background-color:#FCF305;  border-right:solid 1px #000000;"><h3>Duración: 4 meses - del mes 6 al 9</h3></td>
            <td colspan="12" style="width:390; background-color:#FF9900; border-right:solid 1px #000000;"><h3>Duración: 5 meses - del mes 8 al 12</h3></td>
        </tr>
    	<tr height="5px">
        	<td></td>
            <td colspan="10" style="width:390; background-color:#99CCFF; border-left:solid 1px #000000;border-right:solid 1px #000000;"><h3>Objetivo: Tener un Ctrl. del Tiempo, el Dinero y la Entrega del Producto o Servicio</h3></td>
            <td colspan="10" style="width:390; background-color:#1FB714; border-right:solid 1px #000000;"><h3>Objetivo: Generar Utilidades de una manera creciente y consistente</h3></td>
            <td colspan="10" style="width:390; background-color:#CC99FF; border-right:solid 1px #000000;"><h3>Objetivo: Sistematizar todos los aspectos del negocio y generar más tiempo en la gente</h3></td>
            <td colspan="10" style="width:390; background-color:#FCF305; border-right:solid 1px #000000;"><h3>Objetivo: Desarrollar Equipos de Alto Desempeño en el negocio</h3></td>
            <td colspan="12" style="width:390; background-color:#FF9900; border-right:solid 1px #000000;"><h3>Objetivo: Que el personal maneje los sistemas y saque el mayor potencial de los diferentes nichos que se puedan generar</h3></td>
        </tr>
    	<tr height="5px">
        	<td></td>
        	<td colspan="10" style="width:390; background-color:#99CCFF; border-left:solid 1px #000000;border-right:solid 1px #000000;border-bottom:solid 1px #000000;"><h3>Conceptos Clave: SOBREVIVENCIA Y CONTROL</h3></td>
            <td colspan="10" style="width:390; background-color:#1FB714; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>Conceptos Clave: FLUJO Y UTILIDADES</h3></td>
            <td colspan="10" style="width:390; background-color:#CC99FF; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>Conceptos Clave: TIEMPO Y CRECIMIENTO</h3></td>
            <td colspan="10" style="width:390; background-color:#FCF305; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>Conceptos Clave: ARMONIA Y FELICIDAD</h3></td>
            <td colspan="12" style="width:390; background-color:#FF9900; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>Conceptos Clave: TRANQUILIDAD Y DIVERSIFICACIÓN</h3></td>
        </tr>
        <tr>
            <td valign="top"></td>
            <?php
