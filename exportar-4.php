...
?> 
    <table border="0" cellpadding="0" cellspacing="0" class="tableizer-table" width="1623px">
        ...
        <tr>
            <td style="width:42px; font-size:12px;"><b>Sem</b></td>
            ...
            <td width="47" style="width:47px" >21</td>
            ...
            <td width="42" style="width:42px" >39</td>
            <td width="30" style="width:30px" >39</td>
            <td width="30" style="width:30px" >39</td>
            <td width="30" style="width:30px" >43</td>
            <td width="30" style="width:30px" >44</td>
            <td width="30" style="width:30px" >45</td>
            <td width="30" style="width:30px" >42</td>
            <td width="30" style="width:30px" >47</td>
            <td width="30" style="width:30px" >48</td>
            <td width="30" style="width:30px" >49</td>
            <td width="30" style="width:30px" >50</td>
            <td width="30" style="width:30px" >51</td>
            <td width="30" style="width:30px" >52</td>
      </tr>
        <tr>
