...
<?php
	...
	header("Content-Disposition: filename=estrategiasB.xls");
...
?> 
    <table border="0" cellpadding="0" cellspacing="0" class="tableizer-table" width="2393">
		...
		<tr>
            ...
            <td colspan="21" style="width:780; border-top:solid 1px #000000;border-right:solid 1px #000000;border-bottom:solid 1px #000000; text-align:center;"><h1>CUARTO TRIMESTRE</h1></td>
            
        </tr>
        <tr align="center">
            <td style="width:42px; font-size:12px; text-align:left;"><b>Sem</b></td>
            <td width="39" style="width:39px" >1</td>
            <td width="39" style="width:39px" >2</td>
            <td width="39" style="width:39px" >3</td>
            <td width="39" style="width:39px" >4</td>
            <td width="39" style="width:39px" >5</td>
            <td width="39" style="width:39px" >6</td>
            <td width="39" style="width:39px" >7</td>
            <td width="39" style="width:39px" >8</td>
            <td width="39" style="width:39px" >9</td>
            <td width="39" style="width:39px" >10</td>
            <td width="39" style="width:39px" >11</td>
            <td width="39" style="width:39px" >12</td>
            <td width="39" style="width:39px" >13</td>
            <td width="39" style="width:39px" >14</td>
            <td width="39" style="width:39px" >15</td>
            <td width="39" style="width:39px" >16</td>
            <td width="39" style="width:39px" >17</td>
            <td width="39" style="width:39px" >18</td>
            <td width="39" style="width:39px" >19</td>
            <td width="39" style="width:39px" >20</td>            
            <td width="39" style="width:39px" >21</td>
            <td width="42" style="width:42px" >22</td>
            <td width="42" style="width:42px" >23</td>
            <td width="42" style="width:42px" >24</td>
            <td width="42" style="width:42px" >25</td>
            <td width="42" style="width:42px" >26</td>
            <td width="42" style="width:42px" >27</td>
            <td width="42" style="width:42px" >28</td>
            <td width="42" style="width:42px" >29</td>
            <td width="42" style="width:42px" >30</td>
            <td width="42" style="width:42px" >31</td>
            <td width="42" style="width:42px" >32</td>
            <td width="42" style="width:42px" >33</td>
            <td width="42" style="width:42px" >34</td>
            <td width="42" style="width:42px" >35</td>
            <td width="42" style="width:42px" >36</td>
            <td width="42" style="width:42px" >37</td>
            <td width="42" style="width:42px" >38</td>
            <td width="42" style="width:42px" >39</td>
            <td width="42" style="width:42px" >40</td>
            
            <td colspan="2" style="width:60px" >41</td>            
            <td colspan="2" style="width:60px" >42</td>
            <td colspan="2" style="width:60px" >43</td>
            <td colspan="2" style="width:60px" >44</td>
            <td colspan="2" style="width:60px" >45 &nbsp; 46</td>
            <td colspan="2" style="width:60px" >47</td>
            <td colspan="2" style="width:60px" >48</td>
            <td colspan="2" style="width:60px" >49</td>
            <td colspan="2" style="width:60px" >50</td>
            <td colspan="2" style="width:60px" >51 &nbsp; 52 </td>
        </tr>
        <tr>
		...
		<tr valign="top">
            ...
            <td colspan="10" style="width:390; background-color:#FF9900; border-top:solid 1px #000000; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>5.  Y por último lograremos tener una <b>SINERGIA</b> en todo tu negocio y con ello lograr los <b>RESULTADOS MASIVOS</b> (paso 6)</h3></td>
            <td colspan="10" style="width:390; background-color:#C0C0C0; border-top:solid 1px #000000; border-right:solid 1px #000000; border-bottom:solid 1px #000000;"><h3>6.  En esta etapa revisaremos los <b>RESULTADOS</b> que llevas a lo largo de año, los que te faltan y hay qu trabajar más y ya estarás listo para crear nuevas empresas y convertirte en un verdadero empresario</h3></td>
        </tr>
	    <tr height="5px">
        	<td></td>
