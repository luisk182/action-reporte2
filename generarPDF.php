...
<img src="img/logoreporte.jpg" width="300px" height="47px" style="border:none;" /></td></tr><tr><td><p style="text-align:center;color:#014781;">Para:<br/></p></td></tr><tr><td>';



	if($rowInfoReporte['logo']!="logos/") {

	$html.='<img width="180px" src="'.$rowInfoReporte['logo'].'" /><br/>';

	}

	$html.='</td></tr><tr><td><p style="text-align:center;">'.$rowInfoReporte['empresa'].'</p><p style="text-align:center;">'.$rowInfoReporte['cliente'].'<br/></p></td></tr></table>';
...
$html='<p style="text-align:center;">'.$rowInfoReporte['coach'].'</p>';
...
$html .= "<style>
		 .interlineado {line-height:4px !important; font-weight:bold !important;}
...
$sql="select p.id AS id, p.cardinalidad, p.vision, rm.respuesta 
FROM preguntas p, respuestasMetas rm 
WHERE rm.idMeta=".$x." 
AND idReporte=".$_GET['idReporte']." 
AND idUsuario=".$_GET['idU']." 
...
$html.='<tr style="background-color:#404040;color:#ffffff; background: url(img/degradado.png) repeat-x;">
  ...
  <td class="bordegris" width="628" align="left" colspan="6">'.$row1['categoria'].'</td>
...
$html.='<tr nobr="true" class="datos '.$clase.'">
  	...
  	<td width="273">'.$row3['estrategia'].'</td>
